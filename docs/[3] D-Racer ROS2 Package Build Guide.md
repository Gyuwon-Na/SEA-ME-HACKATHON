...
<p align="center">
  <img src="https://raw.githubusercontent.com/topst-development/D-Racer-Kit/refs/heads/docs/revision/docs/asset/3/figure1-ros2-communication-structure.png" alt="ROS2 Communication Structure">
  <br>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/topst-development/D-Racer-Kit/refs/heads/docs/revision/docs/asset/3/figure2-node-topic-message-relationship.png" alt="Node Topic Message Relationship">
  <br>
...
│   ├── [3] D-Racer ROS2 Package Build Guide.md
│   ├── [4] Monitor Package.md
│   ├── [5] Battery Package.md
│   ├── [6] Camera Package.md
│   ├── [7] Joystick & Control Package.md
│   ├── [8] OpenCV Package.md
│   └── asset
├── LICENSE
├── README.md
...
D-Racer의 ROS2 패키지 구조와 각 패키지 간의 관계를 다음과 같이 구성됩니다.(Figure 3)

<p align="center">
  <img src="https://raw.githubusercontent.com/topst-development/D-Racer-Kit/refs/heads/docs/revision/docs/asset/3/figure3-D-Racer-ros2-architecture.png" alt="D-Racer Package Diagram">
  <br>
...
아래 커맨드를 통해 워크스페이스 환경 적용을 진행하주세요. 
```bash
